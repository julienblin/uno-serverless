/**
 * This file comes from the https://github.com/prettymuchbryce/node-http-status project.
 * It is being internalized as a convenience for the framework users.
 */
...
export enum HttpStatusCodes {
   ...
   * to engage in transparent content negotiation itself, and is therefore not a proper end point
   ...
   * it's possible that the range is outside the size of the target URI data.
   */
   ...
   * that used prior request.
   * This has the same semantic than the 302 Found HTTP response code, with the exception that the user agent
